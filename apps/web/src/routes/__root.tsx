...
export const Route = createRootRouteWithContext<RouterAppContext>()({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "A two-day orientation program for newly-elected IEDC Team leads across Kerala. Align, lead, and launch your IEDC journey. July 17–18, 2026 · Marian Engg. College, Tvm.",
      },
      { property: "og:title", content: "TPT 4.0 — The Perfect Trajectory" },
      { property: "og:description", content: "A two-day orientation program for newly-elected IEDC Team leads across Kerala. Align, lead, and launch your IEDC journey. July 17–18, 2026 · Marian Engg. College, Tvm." },
      { property: "og:image", content: "https://tpt-4.vercel.app/tpt-og.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://tpt-4.vercel.app/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "TPT 4.0 — The Perfect Trajectory" },
      { name: "twitter:description", content: "A two-day orientation program for newly-elected IEDC Team leads across Kerala. Align, lead, and launch your IEDC journey. July 17–18, 2026 · Marian Engg. College, Tvm." },
      { name: "twitter:image", content: "https://tpt-4.vercel.app/tpt-og.png" },
    ],
    links: [
      {
        rel: "icon",
